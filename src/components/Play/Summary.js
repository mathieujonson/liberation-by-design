            ...
            <div className="game-wrapper">
                <div className="summary">
                    ...
                    <div className="summary__scores">
                        <p>Game summary:</p>
                        <ol>
                        <li><i className="fa fa-check"></i> <span className="summary__points">2 points</span></li>
                        <li><i className="fa fa-times"></i> <span className="summary__points">0 points</span></li>
                        <li><i className="fa fa-check"></i> <span className="summary__points">1 points</span></li>
                        <li><i className="fa fa-check"></i> <span className="summary__points">3 points</span></li>
                        <li><i className="fa fa-check"></i> <span className="summary__points">2 points</span></li>
                        <li><i className="fa fa-check"></i> <span className="summary__points">2 points</span></li>
                        <li><i className="fa fa-check"></i> <span className="summary__points">2 points</span></li>
                        <li><i className="fa fa-check"></i> <span className="summary__points">2 points</span></li>
